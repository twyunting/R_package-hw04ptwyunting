...
$$\
- That is, element n is the sum of element n−1 and the value of the difference between elements n−3 and n−2 divided by two.\
- For example, if we let x1=3, x2=1, and x3=10, then x4 is
$$
x_4 = 10 + \frac{3 - 1}{4} = 10.5
$$\
- This is a basic example which shows you how to calculate this formula:
